 ...
 * Name : EXT031MI.AddConstrType
 * Description : Add records to the EXT031 table.
...
public class AddConstrType extends ExtendM3Transaction {
  ...
  public AddConstrType(MIAPI mi, DatabaseAPI database, ProgramAPI program, LoggerAPI logger) {
    this.mi = mi
  ...
  public void main() {
    ...
    if (!ext031Query.read(ext031Request)) {
      ext031Request.set("EXZTYP", mi.in.get("ZTYP"))
