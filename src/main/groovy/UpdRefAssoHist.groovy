...
public class UpdRefAssoHist extends ExtendM3Transaction {
  ...
  public void main() {
    ...
    flagUpdate = flagUpdate || !mi.in.get("SAPR").equals(ext010Request.get("EXSAPR"))
    flagUpdate = flagUpdate || !mi.in.get("SULE").equals(ext010Request.get("EXSULE"))
    flagUpdate = flagUpdate || !mi.in.get("SULD").equals(ext010Request.get("EXSULD"))
    flagUpdate = flagUpdate || !mi.in.get("RSCL").equals(ext010Request.get("EXRSCL"))
    flagUpdate = flagUpdate || !mi.in.get("CMDE").equals(ext010Request.get("EXCMDE"))
    flagUpdate = flagUpdate || !mi.in.get("TVDT").equals(ext010Request.get("EXTVDT"))
    flagUpdate = flagUpdate || !mi.in.get("FVDT").equals(ext010Request.get("EXFVDT"))
    flagUpdate = flagUpdate || !mi.in.get("LVDT").equals(ext010Request.get("EXLVDT"))
